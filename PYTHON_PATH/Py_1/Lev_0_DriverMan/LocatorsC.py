...
class Find_Flights:
    TravelTheWorld = Common.TravelTheWorld
    home = Common.home
    Chooses = By.XPATH, "//tbody/tr/td[1]/*"
    H3 = By.XPATH, "//div[2]/h3"
    Prices = By.XPATH, "//tbody/tr/td[last()]"
# ------------------------------------
class Purchase:
    H2 = By.CSS_SELECTOR, "div.container > h2"
    Price = By.CSS_SELECTOR, "div.container > p:nth-child(4)"
    TravelTheWorld = Common.TravelTheWorld
    home = Common.home
